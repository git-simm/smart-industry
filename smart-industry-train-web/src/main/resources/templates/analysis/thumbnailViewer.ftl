...
<html>
  ...
  <body>
    ...
    <div id="mainViewContainer">
      <embed id="mainView" type="image/svg+xml" src="/static/svg/tiger.svg"/>
    </div>
    ...
    <div id="thumbViewContainer">
      ...
      <embed id="thumbView" type="image/svg+xml" src="/static/svg/tiger.svg" class="thumbViewClass"/>
    </div>

    <script src="/static/js/common/svg-pan-zoom.js" type="text/javascript" ></script>
    <script src="/static/js/common/thumbnailViewer.js" type="text/javascript" ></script>
